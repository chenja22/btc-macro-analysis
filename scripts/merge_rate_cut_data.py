...
btc_ctrl = pd.read_csv("data/btc_interest_rate_control_period_clean.csv", parse_dates=["date"])
btc_evt = pd.read_csv("data/btc_interest_rate_event_period_clean.csv", parse_dates=["date"])
...
btc.to_csv("data/btc_all_ratecut_merged_clean.csv", index=False)
